...
export function CoordinatorMobileHeader({ onMenuClick }: CoordinatorMobileHeaderProps) {
  return (
    <div className="fixed top-0 left-0 right-0 z-40 md:hidden bg-white dark:bg-gray-950 border-b h-16 flex items-center justify-between px-4">
      {/* Menu Button */}
      <Button
        variant="ghost"
        size="sm"
      ...
      <div className="flex-1 text-center">
        <h1 className="text-lg font-bold">SPRS</h1>
